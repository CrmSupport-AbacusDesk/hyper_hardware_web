...
import { ItemMasterUploadComponent } from './master/item-master-upload/item-master-upload.component';
import { PasswordModalComponent } from './password-modal/password-modal.component';
// import { MatCarouselModule } from '@ngmodule/material-carousel';
import { CouponlogsComponent } from './couponlogs/couponlogs.component';
import { EnlargefeedbackimgComponent } from './enlargefeedbackimg/enlargefeedbackimg.component';
import { ChangeStatusRejectComponent } from './change-status-reject/change-status-reject.component';
...
const routes: Routes = [
  ...
  {path: 'category', component:ProductcategoryListComponent , canActivate: [AuthGuard] },
  ...
  { path: '**', redirectTo: ''},
  {path: 'password-modal', component:PasswordModalComponent , canActivate: [AuthGuard] },
...
@NgModule({
  declarations: [
    ...
    ItemMasterUploadComponent,
    PasswordModalComponent,
    UploaddigitalcatComponent,
    CouponlogsComponent,
    EnlargefeedbackimgComponent,
