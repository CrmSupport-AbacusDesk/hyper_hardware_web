...
export class OfferDetailComponent implements OnInit {
    ...
    getOfferDetails() {
        ...
        .subscribe(d => {
            ...
            this.addOffer.country = d.offer.country
    ...
    requestchangeStatus(i,id,status)
    {
        ...
        saveOffer(form:any) {
            ...
            if(this.addOffer.country == "Nepal"){
                this.districts = {};
                this.districts.created_by ={};
                this.districts = this.districts.created_by;
            }
            console.log(this.districts);
            this.db.post_rqst( {'country':this.addOffer.country,  'area' : this.districts, 'login_id' :this.db.datauser.id ,'offer_id':this.offer_id }, 'offer/updateOfferArea')
            .subscribe( d => {
                this.loading_list =false;
