...
import { AddgiftComponent } from '../addgift/addgift.component';
...
deactiveStatus(id)
{
  ...
  .subscribe( d => {
    ...
    if(d['status'] === 'REDEEMEXIST'){
        this.dialog.success( "Can't Delete Gift (Redeem Request Exists)"); 
...
addGift() {
    const dialogRef = this.alrt.open(AddgiftComponent,{
