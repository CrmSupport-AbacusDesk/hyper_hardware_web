...
import { ItemMasterUploadComponent } from '../item-master-upload/item-master-upload.component';
...
export class ProductsListComponent implements OnInit {
    ...
    editProduct(id,index){
        ...
        this.productimg.image = this.uploadurl + this.productForm.image_name;
    ...
    saveProduct()
    {
        ...
        this.productForm.image = this.productimg.image
        ...
        .subscribe( d => {
            ...
            this.dialog.success('Product successfully updated');
            this.toggle = "false"
            this.getProductList('');
            this.productForm = {};
            this.productForm.image = {}
    ...
    isGroupImage = (e) => {
        console.log(e.checked);
        if(e.checked==true){
            this.is_group_image = 1;
        }else {
            this.is_group_image = 0;
        }
    }
    ...
    importItem(): void {
        const dialogRef = this.alrt.open(ItemMasterUploadComponent,{
            width: '500px',
