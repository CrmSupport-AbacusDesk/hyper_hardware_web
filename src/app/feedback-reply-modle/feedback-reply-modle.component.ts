...
export class FeedbackReplyModleComponent implements OnInit {
    ...
    constructor(public alrt:MatDialog,public dialog: DialogComponent, @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<FeedbackComponent>, public db:DatabaseService) { 
        console.log(data);
    ...
    {
        console.log("url ======================>",url);
        const dialogRef = this.alrt.open(EnlargefeedbackimgComponent,{
            // width: '500px',
